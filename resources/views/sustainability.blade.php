...
@section('content')
    <main class="content">
        <section class="block block-banner-text text-centered wow animate__fadeIn" data-wow-delay="2s">
            ...
            <div class="container">
                <h1 class="title page-title wow animate__fadeIn" data-wow-delay="2.5s">Our Promise</h1>
        ...
        <section class="block block-sustainable-future wow animate__fadeInUp" data-wow-delay=".5s" data-wow-offset="30">
            <div class="container">
                <h2 class="title block-title text-centered wow animate__fadeIn" data-wow-delay="1s">Sustainable future</h2>
                <div class="text-group">
                    <div class="image wow animate__fadeInLeft" data-wow-delay="1.5s">
                        <img src="{{asset('img/temp/future-banner-1.jpg')}}" alt="" loading="lazy">
                    </div>
                    <div class="text wow animate__fadeInRight" data-wow-delay="2s">
                        <h3 class="title">Environmental Protection</h3>
                        <div class="descr wow animate__fadeInUp" data-wow-delay="2.5s">
                            ASW is proud to present its 330mL, 500mL, 1000mL made of 100% fully recyclable plastic bottles. ASW’s intent is to adopt fully biodegradable plastic for its packaging to ensure its products do not cause environmental damage.
                        </div>
                    </div>
                </div>
                <div class="text-group">
                    <div class="image wow animate__fadeInLeft" data-wow-delay="1s">
                        <img src="img/temp/future-banner-2.jpg" alt="" loading="lazy">
                    </div>
                    <div class="text wow animate__fadeInRight" data-wow-delay="2s">
                        <h3 class="title">Rainforest foundation</h3>
                        <div class="descr wow animate__fadeInUp" data-wow-delay="2.5s">
                            ASW is committed to developing a consumer donation program, with the conservation platform sanctioned by the Brazilian government, so that at least $.20 of every one liter purchased is destined to protect the Amazon Rainforest.
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="block block-question-form wow animate__fadeInUp" data-wow-delay=".5s">
            <div class="bg">
                <img src="{{asset('img/bg/bg-3.jpg')}}" alt="" loading="lazy">
            </div>
            <div class="container">
                <h2 class="title block-title text-centered wow animate__fadeIn" data-wow-delay="1s">Do you have a question?</h2>
                <form action="{{route('createFeedback')}}" class="question-form">
                    @csrf
                    <div class="form-content wow animate__fadeInUp" data-wow-delay="1.5s">
                    ...
                    <button type="submit" class="btn submit wow animate__fadeInUp" data-wow-delay="2s">submit</button>
                </form>
            </div>
        </section>
    </main>
