...
@section('content')
    <main class="content">
        <section class="block block-banner-text text-centered wow animate__fadeIn" data-wow-delay="2s">
            ...
            <div class="container">
                <h1 class="title page-title wow animate__fadeIn" data-wow-delay="2.5s">Saving the lungs <br> of the world</h1>
        ...
        <section class="block block-our-story wow animate__fadeInUp" data-wow-delay=".5s" data-wow-offset="50">
            <div class="bg">
                <img src="img/bg/our-story-bg.jpg" alt="" loading="lazy">
            </div>
            <div class="container">
                <div class="inner">
                    <div class="text wow animate__fadeInLeft" data-wow-delay="1s">
                        <h2 class="title block-title">Our story</h2>
                        <div class="descr wow animate__fadeIn" data-wow-delay="2s">
                            <p>
                                Amazon Spring Waters presents the first global bottled water brand from Brazil, with a mission and brand built on the premise of saving the world’s “lungs”, the Amazon Rainforest.
                            </p>
                            <p>
                        ...
                        <a href="/" class="learn-more wow animate__fadeInUp" data-wow-delay="2.5s">Learn more</a>
                    </div>
                    <div class="banner wow animate__fadeInRight" data-wow-delay="1.5s">
        ...
        <section class="block block-core-beliefs text-centered wow animate__fadeInUp" data-wow-delay=".5s">
            <div class="bg">
                <img src="img/bg/bg-9.jpg" alt="" loading="lazy">
            </div>
            <div class="container">
                <h2 class="title block-title wow animate__fadeIn" data-wow-delay="1s">Our Core Beliefs</h2>
                <div class="icons">
                    <div class="item wow animate__fadeInUp" data-wow-delay="1.3s">
                        <div class="item-icon">
                    ...
                    <div class="item wow animate__fadeInUp" data-wow-delay="1.6s">
                        <div class="item-icon">
                            <svg width="57" height="56" viewBox="0 0 57 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="item wow animate__fadeInUp" data-wow-delay="1.9s">
                        <div class="item-icon">
