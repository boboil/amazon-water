...
@section('content')
    <main class="content">
        <section class="block block-banner-text text-centered wow animate__fadeIn" data-wow-delay="1.2s">
            ...
            <div class="container">
                <h1 class="title page-title wow animate__fadeIn" data-wow-delay="1.5s">Saving the lungs <br> of the
                    world</h1>
                ...
                <div class="inner">
                    <div class="text wow animate__fadeInLeft" data-wow-delay=".6s">
                        ...
                        <div class="descr wow animate__fadeIn" data-wow-delay="1.2s">
                            <p>
                                Amazon Spring Water has been purified over hundreds of years, filtering through
                                sandstone and basalt formations, being part of one of the world’s largest underground
                                lakes.
                            </p>
                            <p>
                                This purification process allows for the finest water to surface, arriving in your
                                bottle.
                            </p>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="icons">
                    <div class="item wow animate__fadeInUp" data-wow-delay=".9s">
                        <div class="item-icon">
                            <svg width="57" height="56" viewBox="0 0 57 56" fill="none"
                                ...
                                <path
                                    d="M9.83398 34.9998C9.83398 34.9998 12.1673 32.6665 19.1673 32.6665C26.1673 32.6665 30.834 37.3332 37.834 37.3332C44.834 37.3332 47.1673 34.9998 47.1673 34.9998V6.99984C47.1673 6.99984 44.834 9.33317 37.834 9.33317C30.834 9.33317 26.1673 4.6665 19.1673 4.6665C12.1673 4.6665 9.83398 6.99984 9.83398 6.99984V34.9998Z"
                                    stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M9.83398 51.3333V35" stroke="white" stroke-width="2" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="item-title">Citizenship</div>
                        <div class="item-descr">
                            We trust in people. By providing the public with <br> the means to save the Amazon and
                            benefit the <br> environment
                        </div>
                    </div>
                    <div class="item wow animate__fadeInUp" data-wow-delay="1.2s">
                        <div class="item-icon">
                            <svg width="57" height="56" viewBox="0 0 57 56" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M28.5007 39.6668C34.944 39.6668 40.1673 34.4435 40.1673 28.0002C40.1673 21.5568 34.944 16.3335 28.5007 16.3335C22.0573 16.3335 16.834 21.5568 16.834 28.0002C16.834 34.4435 22.0573 39.6668 28.5007 39.6668Z"
                                    stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M28.5 2.3335V7.00016" stroke="white" stroke-width="2" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M28.5 49V53.6667" stroke="white" stroke-width="2" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M10.3457 9.84668L13.659 13.16" stroke="white" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M43.3398 42.8398L46.6532 46.1532" stroke="white" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M2.83398 28H7.50065" stroke="white" stroke-width="2" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M49.5 28H54.1667" stroke="white" stroke-width="2" stroke-linecap="round"
                                      stroke-linejoin="round"/>
                                <path d="M10.3457 46.1532L13.659 42.8398" stroke="white" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M43.3398 13.16L46.6532 9.84668" stroke="white" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </div>
                        <div class="item-title">Environment</div>
                        <div class="item-descr">
                            We cannot survive without a healthy world <br> organism. The environment is our future and
                            <br> we must take steps now to protect it
                        </div>
                    </div>
                    <div class="item wow animate__fadeInUp" data-wow-delay="1.5s">
                        ...
                        <div class="item-descr">
                            Our legacy will be the Amazon and a successful <br> model demonstrating how creativity and
                            ethical <br> stewardship can result in transformation.
                        </div>
                    </div>
                </div>
            </div>
