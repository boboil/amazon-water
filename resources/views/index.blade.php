...
@section('content')
    <main class="content">
        <section class="block block-homescreen wow animate__fadeIn" data-wow-delay="2s">
            <div class="bg">
            ...
            <div class="container">
                <div class="text">
                    <h1 class="title page-title wow animate__fadeIn" data-wow-delay="2.5s">Amazon Spring Waters</h1>
...
{{--                    <a href="/" class="btn wow animate__fadeInUp" data-wow-delay="3.5s" target="_blank"--}}
{{--                       title="buy on Amazon">Buy now</a>--}}
                </div>
                <figure class="figure wow animate__fadeIn" data-wow-delay="4s">
        ...
        <section class="block block-product-slider wow animate__fadeInUp" data-wow-delay=".5s" data-wow-offset="50">
            <div class="bg">
        ...
        <section class="block block-images-text wow animate__fadeInUp" data-wow-delay=".5s">
            <div class="container">
                <a href="{{route('about')}}" class="image-link wow animate__fadeInLeft" data-wow-delay="1s">
...
{{--                </a>--}}
                <a href="{{route('about')}}" class="image-link wow animate__fadeInUp" data-wow-delay="3s">
